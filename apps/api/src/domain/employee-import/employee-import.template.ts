...
const EXAMPLE_ROWS: Record<ImportColumn, string>[] = [
  ...
  },
  {
    ...
    idIssueDate: '2016-11-02',
    idIssuePlace: 'Cục CSQLHC về TTXH',
    personalEmail: 'binh.personal@gmail.com',
    education: 'Đại học Kinh tế - QTKD',
    maritalStatus: 'SINGLE',
    permanentAddress: '88 Lê Lợi, Hải Châu, Đà Nẵng',
    currentAddress: '88 Lê Lợi, Hải Châu, Đà Nẵng',
    emergencyContactName: 'Trần Văn Cường',
    emergencyContactRelationship: 'Anh trai',
    emergencyContactPhone: '0987654321',
    bankAccountNumber: '9876543210',
    bankName: 'Techcombank',
    bankBranch: 'CN Đà Nẵng',
    taxCode: '8987654321',
    socialInsuranceNumber: '9876543210',
    healthcareFacility: 'BV Đà Nẵng',
    motorbikeRegistration: 'Yamaha Exciter - Xanh - 43B1-67890',
  },
];
...
const STRINGS: Record<ImportLang, {
  ...
  vi: {
    ...
    notes: [
      ...
      'Tình trạng hôn nhân: SINGLE / MARRIED / DIVORCED / WIDOWED / OTHER.',
      'Ngày cấp CCCD cũng dùng định dạng YYYY-MM-DD; Email cá nhân phải đúng định dạng email.',
      'Các cột mở rộng (nơi sinh, địa chỉ, ngân hàng, thuế, BHXH, liên hệ khẩn cấp, xe máy...) đều không bắt buộc.',
  ...
  en: {
    ...
    notes: [
      ...
      'ID issue date also uses YYYY-MM-DD; Personal email must be a valid email format.',
      'The extended columns (place of birth, addresses, bank, tax, social insurance, emergency contact, motorbike...) are all optional.',
