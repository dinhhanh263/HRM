...
import type { OvertimeApprovalDto, ApprovalDecision } from '@hrm/shared';
import { cn } from '@/lib/utils';
import { Check, Clock, Undo2, SkipForward } from 'lucide-react';
import { formatDateTime } from '../utils';

interface OvertimeTimelineProps {
  approvals: OvertimeApprovalDto[];
...
export function OvertimeTimeline({ approvals, currentStep }: OvertimeTimelineProps) {
  ...
  function approverLabel(a: OvertimeApprovalDto): string {
  ...
  function noteText(a: OvertimeApprovalDto): string | null {
                        ...
                        <p className="text-xs text-text-muted mt-0.5">
                          {a.decidedBy?.fullName
                            ? t('timeline.decidedBy', {
                                ...
                                date: formatDateTime(a.decidedAt, i18n.language),
                              })
                            : formatDateTime(a.decidedAt, i18n.language)}
                        </p>
                      )}
                      {noteText(a) && (
