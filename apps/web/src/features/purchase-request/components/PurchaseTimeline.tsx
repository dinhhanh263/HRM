...
import type { PurchaseRequestApprovalDto, ApprovalDecision } from '@hrm/shared';
...
export function PurchaseTimeline({ approvals, currentStep }: PurchaseTimelineProps) {
  ...
  function approverLabel(a: PurchaseRequestApprovalDto): string {
  ...
  function noteText(a: PurchaseRequestApprovalDto): string | null {
                        ...
                        <p className="text-xs text-text-muted mt-0.5">
                          {a.decidedBy?.fullName
                            ? t('timeline.decidedBy', {
                                ...
                                date: formatPurchaseDate(a.decidedAt),
                              })
                            : formatPurchaseDate(a.decidedAt)}
                        </p>
                      )}
                      {noteText(a) && (
