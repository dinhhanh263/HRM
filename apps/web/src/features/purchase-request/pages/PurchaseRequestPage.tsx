...
export function PurchaseRequestPage() {
  ...
  const filters = {
    scope: (isStats ? 'all' : tab) as PurchaseRequestScope,
    status: statusFilter,
  ...
  async function handleExport() {
    ...
    setExporting(true);
    try {
      await exportPurchaseRequests(filters);
  ...
  return (
    <div className="p-6 space-y-6 max-w-screen-xl">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <Can permission="purchase_request:create">
        ...
        <>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Select
              ...
              onValueChange={(v) => setStatusFilter(v === 'all' ? undefined : (v as PurchaseRequestStatus))}
            >
            ...
            <div className="ml-auto flex items-center gap-3">
              ...
              <Can permission="purchase_request:export">
          ...
          {isLoading ? (
            ...
            <PurchaseRequestTable items={items} showEmployee={tab !== 'mine'} onRowClick={setDetailId} />
          )}
        </>
      )}
